...
mount -o noatime,compress=lzo,space_cache=v2,subvol=@snapshots "${ROOT}" /mnt/.snapshots
mount -o noatime,compress=lzo,space_cache=v2,subvol=@var_log "${ROOT}" /mnt/var/log
...
pacstrap /mnt networkmanager network-manager-applet wireless_tools vim amd_ucode bluez bluez-utils blueman git --noconfirm --needed

# fstab
genfstab -U /mnt >> /mnt/etc/fstab

arch-chroot /mnt sh hyprland.sh
